...
<!-- #600 aniboom (referer + useragent, mpd), kodik (m3u8/slow mp4) (seria/video) "*://kodik.info/*", sibnet (referer) "*://video.sibnet.ru/*", -->

# 1.x

- Теперь, при включенной опции "Не переводить с родного языка" проверяется только язык с которого переводится видео (ранее срабатывало только при одинаковой паре языков, например русский-русский, английкий-англиский и т.п.)

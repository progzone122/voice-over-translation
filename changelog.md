...
- Функционал запросов к API переписан с использованием vot.js (Поубирать повторы кода, который уже есть в vot.js)
- Добавлена поддержка Patreon (`patreon.com`)
<!-- - Добавлена поддержка Reddit (`reddit.com`) -->
